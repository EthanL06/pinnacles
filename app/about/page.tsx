...
const Page = () => {
  return (
    <>
      <Head>
        <link rel="canonical" href="https://pinnacles.app/about" />
      </Head>
      <div className="noise-bg relative flex h-full min-h-screen w-full flex-col gap-8 gap-y-8 overflow-clip px-6 pb-16 pt-40 md:px-24 lg:px-48">
        ...
        <div className="flex flex-col gap-y-8 text-2xl font-medium tracking-tight sm:text-3xl">
          ...
          <p>
            ...
            collected hundreds and wanted a simple way to organize and share
            them.
          </p>
          ...
          <p>
            ...
            <Link
              ...
              href="https://github.com/EthanL06/pinnacles/issues"
            >
              share any feedback
            </Link>{" "}
            you have—I’d love to hear from you! If you’ve found this site
            helpful, consider{" "}
            <Link
              target="_blank"
              className="text-primary underline"
          ...
          <div className="flex flex-col gap-y-2 pt-10">
            <p className="text-right font-serif">- Ethan.</p>
            ...
            <div className="flex justify-end gap-x-2">
              ...
              <Link
                target="_blank"
                href="https://buymeacoffee.com/ethanlanting"
                className={cn(
                  buttonVariants({
                    variant: "outline",
                    size: "icon",
              ...
              >
                <svg
                  ...
                  className="*:fill-[#0D0C22] *:dark:fill-white"
